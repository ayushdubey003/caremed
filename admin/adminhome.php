...
<div class="super_container">
	...
	<div class="about">
        <div class="button home_button" style="margin-left:35%">
			<a href="doctor.php" style="width:400px;text-align:center">Register a Doctor</a>
		</div>
		<br>
		<div class="button home_button" style="margin-left:35%">
			<a href="nurse.php" style="width:400px;text-align:center">Register a Nurse/Ward Boy</a>
        </div>
		<div class="button home_button" style="margin-left:35%;margin-bottom:150px">
			<a href="receptionist.php" style="width:400px;text-align:center">Register a Receptionist</a>
        </div>
