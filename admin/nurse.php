<head>
<title>Nurse/Wardboy registration</title>
...
<div class="super_container">
	...
	<div class="about">
        <form method="POST" action="nurse.php" style="margin-left:50px;margin-bottom:100px">
            <input type="radio" name="post" value="1" checked  style="margin-left:20%"> Nurse
            <input type="radio" name="post" value="2" style="margin-left:20px;margin-bottom:50px"> Wardboy<br> 
